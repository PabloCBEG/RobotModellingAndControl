...
function [xyz,angEuler] = CinematicaDirecta_sin_la_base(in)
...
%     theta   = -q2;
%     psi     = 0;
    theta   = atan2(sin(q2),-cos(q2));

    phi     = atan2(sin(q1)*sin(q2)/sin(theta),cos(q1)*sin(q2)/sin(theta));
    
    psi     = atan2(0,sin(q2)/sin(theta));
  % ----------------------------------------------------------------------  
